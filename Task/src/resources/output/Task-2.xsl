<?xml version="1.0" encoding="UTF-8"?><Objects>
	<Object ID="10" Type="Function" Schema="" Name="NESTED_FN_CALL_PROBLEM" java_package="">
		...
		<Function ID="5" Name="InsertDtl" Out="No" type="NUMBER" target_type="BigDecimal" DML="NO" IsDb="false">
			<Param ID="6" Name="p_LOGIN_ID" pos="1" type="VARCHAR2" target_type="UNKNOWN" In="1"/>
			<Param ID="47" Name="p_second_PARAM" pos="2" type="DATE" target_type="UNKNOWN" In="1"/>
			<Param ID="48" Name="p_third_PARAM" pos="3" type="DATE" target_type="UNKNOWN" Out="1"/>
	...
	<Object ID="36" Type="Procedure" Schema="USER_SCHEMA" Name="NESTED_MULTIPLY_5" java_package="">
		...
		<Function ID="11" Name="fn_n_2" Out="No" type="VARCHAR2" target_type="UNKNOWN" DML="NO" IsDb="false"/>
	</Object>
	...
	<Object ID="22" Type="Package" Schema="" Name="NESTED_FN_IN_PKG">
		<Function ID="23" Name="nested_multiply_5" Out="No" type="INTEGER" target_type="UNKNOWN" isPrivate="No" DML="NO" IsDb="false" java_package="">
			<Param ID="24" Name="G_CHECK_OK" pos="1" type="VARCHAR2" target_type="UNKNOWN" Out="1" In="1"/>
			<Param ID="25" Name="p_dob" pos="2" type="DATE" target_type="UNKNOWN" In="1"/>
			<Param ID="26" Name="p_surname" pos="3" type="DATETIME" target_type="UNKNOWN" In="1"/>
			<Param ID="27" Name="p_maiden_name" pos="4" type="VARCHAR2" target_type="UNKNOWN" In="1"/>
			<Param ID="45" Name="p_UPDATE_DATE" pos="5" type="DATETIME" target_type="Timestamp" In="1"/>
		</Function>
		<Function ID="28" Name="fn_nest" Out="No" type="INT" target_type="UNKNOWN" isPrivate="Yes" DML="NO" IsDb="false" java_package=""/>
	</Object>
	...
	<Object ID="37" Type="Package" Schema="" Name="NESTED_FN_USING_RECORD">
		<Procedure ID="38" Name="sp_outer" Out="No" isPrivate="No" IsDb="true" java_package="">
			...
			<Param ID="40" Name="LastName" pos="2" type="VARCHAR2" target_type="UNKNOWN" In="1"/>
			...
			<Param ID="42" Name="City" pos="5" type="VARCHAR2" target_type="UNKNOWN" In="1"/>
			<Param ID="43" Name="Street" pos="6" type="VARCHAR2" target_type="UNKNOWN" In="1"/>
		</Procedure>
